...
exports.show = function(req, res) {
    ...
    if (req.query.register === "success") {
        ...
        message = "We're sorry, but that is not a valid username or password.";
        messageType = 2;
    } else if (req.query.apply === "success") {
        message = "Congratulations! You have successfully applied for the position.";
        messageType = 1;
    }
